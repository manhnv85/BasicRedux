...
export default class Sample extends Component {
  ...
  xuly(){
      this.setState({animation: 'fadeInUpBig'});
      this.setState({animation: 'fadeInRightBig'});
      this.setState({animation: 'bounce'});
      this.refs.view.fadeInUpBig(1000).then((endState) =>{
        this.refs.view.fadeInRightBig(1000);
      }).then(() => {
        this.refs.view.bounce(5000);
      });
  }
  ...
  render() {
    ...
    return (
      <View animation="fadeIn" style={styles.container} useNativeDriver>
        ...
        <TouchableWithoutFeedback onPress={() => this.xuly()}>
        <Animatable.View animation={this.state.animation} duration={5000}  iterationCount="infinite" ref="view" style={{height: 200, backgroundColor: '#ccc'}}>
          <Text>Bounce me!</Text>
        </Animatable.View>
      </TouchableWithoutFeedback>
